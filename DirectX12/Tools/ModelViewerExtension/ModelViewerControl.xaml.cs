...
public partial class ModelViewerControl : UserControl
{
    ...
    private Model3DGroup CreateModelGeometry(RuntimeSkinModel model)
    {
        ...
        foreach (int submesh_index in Enumerable.Range(0, model.Submeshes.Count))
        {
            ...
            DiffuseMaterial material = runtime_material is null ? new DiffuseMaterial(new SolidColorBrush(Color.FromRgb(210, 210, 210))) : CreateDiffuseMaterial(runtime_material);
